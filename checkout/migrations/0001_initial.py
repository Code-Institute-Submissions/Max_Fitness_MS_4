...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('subscriptions', '0002_membership_included_extras'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stripe_pid', models.CharField(default='', max_length=245)),
            ],
        ),
        migrations.CreateModel(
            name='OrderLineItem',
            fields=[
                ...
                ('subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='subscriptions.membership')),
            ],
        ),
    ]
